...
const Footer = () => {
  return (
    <>
      <footer className="border-2 border-[#415991] rounded-t-[40px] w-full min-h-[200px] mt-40 flex flex-col items-center">
        <div className="flex flex-row justify-between w-[80%] mx-auto mt-5">
          <div className="flex flex-col gap-5">
            <AnchorLink
              className="text-[#415991] text-16 font-medium transition-all hover:scale-110"
              href=""
            >
              Форма для связи
            </AnchorLink>
          ...
          >
            ...
            <span className="text-20 text-[#415991] font-medium">
              Ebel Vladimir
            </span>
          </Link>
          <div className="flex flex-col gap-5">
            <span className=" text-[#415991] text-16 font-medium">
              Мы в соцсетях:
            </span>
            ...
            <Link
              to="tel:+79952920084"
              className="text-[#415991] text-16 font-medium"
            >
              +7 995 292 00 84
            </Link>
          </div>
        </div>
        <div className="w-[80%] my-5 h-[1px] bg-[#415991]"></div>
        <p className="font-medium text-16 text-[#415991] text-center">
        ...
        <span className="font-medium text-16 text-[#41599170] text-center my-3">
